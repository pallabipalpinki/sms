  ...
  <tbody>
    ...
    <tr>
      ...
      <th><a href="#" class="btn btn-sm btn-info">show</a>
          <a href="{{url('/admin/student-edit/'.$data->id)}}" class="btn btn-sm btn-warning">edit</a>
          <a href="{{url('/admin/student-delete/'.$data->id)}}" class="btn btn-sm btn-danger">delete</a>
          <a href="{{url('admin/student-attendence/'.$data->id)}}">Attendence - </a>
      </th>
    </tr>
    @endforeach
